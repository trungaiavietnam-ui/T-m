...
<!--_html_template_end_--></template> <!-- presubmit: ignore-long-line -->
  ...
  <ntp-logo id="logo" doodle-boxed_="" show-tight-doodle-boxing_="" single-colored=""><template shadowrootmode="open"><!----><!--_html_template_start_--><!--?lit$823312683$-->
  <div id="logo"></div>
...
<cr-tooltip id="tooltip" for="indicator" fit-to-visible-bounds="" part="tooltip" position="top" style="--paper-tooltip-delay-in: 500ms; --cr-tooltip-offset: 14px;"><template shadowrootmode="open"><!---->
  ...
  <slot name="tooltip-text"><!--?lit$823312683$--></slot>
</cr-tooltip></template>
      ...
      <div class="tile-title title-ltr">
        <span><!--?lit$823312683$-->Google Trang tính</span>
      </div>
    </div>
  <!----><!---->
...
<cr-tooltip id="tooltip" for="indicator" fit-to-visible-bounds="" part="tooltip" position="top" style="--paper-tooltip-delay-in: 500ms; --cr-tooltip-offset: 14px;"><template shadowrootmode="open"><!---->
  ...
  <slot name="tooltip-text"><!--?lit$823312683$--></slot>
      ...
      <div class="tile-title title-ltr">
        <span><!--?lit$823312683$-->lich-van-trung-2026/sw.js at main · toilatoiuy/lich-van-trung-2026</span>
      </div>
    </div>
  <!----><!---->
...
<cr-tooltip id="tooltip" for="indicator" fit-to-visible-bounds="" part="tooltip" position="top" style="--paper-tooltip-delay-in: 500ms; --cr-tooltip-offset: 14px;"><template shadowrootmode="open"><!---->
  ...
  <slot name="tooltip-text"><!--?lit$823312683$--></slot>
      ...
      <div class="tile-title title-ltr">
        <span><!--?lit$823312683$-->Hệ thống quản lý thông tin GV và CBQLCSGD</span>
      </div>
    </div>
  <!----><!---->
...
<cr-tooltip id="tooltip" for="indicator" fit-to-visible-bounds="" part="tooltip" position="top" style="--paper-tooltip-delay-in: 500ms; --cr-tooltip-offset: 14px;"><template shadowrootmode="open"><!---->
  ...
  <slot name="tooltip-text"><!--?lit$823312683$--></slot>
      ...
      <div class="tile-title title-ltr">
        <span><!--?lit$823312683$-->Studio Liên đội Xuân Lai 8.0 PRO</span>
      </div>
    </div>
  <!----><!---->
...
<cr-tooltip id="tooltip" for="indicator" fit-to-visible-bounds="" part="tooltip" position="top" style="--paper-tooltip-delay-in: 500ms; --cr-tooltip-offset: 14px;"><template shadowrootmode="open"><!---->
  ...
  <slot name="tooltip-text"><!--?lit$823312683$--></slot>
      ...
      <div class="tile-title title-ltr">
        <span><!--?lit$823312683$-->Vercel</span>
      </div>
    </div>
  <!----><!---->
...
<cr-tooltip id="tooltip" for="indicator" fit-to-visible-bounds="" part="tooltip" position="top" style="--paper-tooltip-delay-in: 500ms; --cr-tooltip-offset: 14px;"><template shadowrootmode="open"><!---->
  ...
  <slot name="tooltip-text"><!--?lit$823312683$--></slot>
      ...
      <div class="tile-title title-ltr">
        <span><!--?lit$823312683$-->Project overview</span>
      </div>
    </div>
  <!----><!---->
...
<cr-tooltip id="tooltip" for="indicator" fit-to-visible-bounds="" part="tooltip" position="top" style="--paper-tooltip-delay-in: 500ms; --cr-tooltip-offset: 14px;"><template shadowrootmode="open"><!---->
  ...
  <slot name="tooltip-text"><!--?lit$823312683$--></slot>
      ...
      <div class="tile-title title-ltr">
        <span><!--?lit$823312683$-->Claude</span>
      </div>
    </div>
  <!---->
...
<div id="hoverBackground" part="hoverBackground"></div></template>
    ...
    <div class="tile-title">
      <span><!--?lit$823312683$-->Thêm lối tắt</span>
    </div>
  </cr-button>
  <div>
...
<div id="hoverBackground" part="hoverBackground"></div></template>
      ...
      <div class="tile-title">
        <span><!--?lit$823312683$-->Hiện thêm</span>
      </div>
    </cr-button>
...
<div id="hoverBackground" part="hoverBackground"></div></template>
      ...
      <div class="tile-title">
        <span><!--?lit$823312683$-->Ẩn bớt</span>
      </div>
    </cr-button>
  </div>
...
<!-- This wrapper is necessary, such that the "pulse" animation is not
  ...
  <div id="content-wrapper" part="wrapper">
    ...
    <div slot="title"><!--?lit$823312683$--></div>
...
<div id="error" aria-live="assertive"><!--?lit$823312683$--></div></template>
      </cr-input>
...
<div id="hoverBackground" part="hoverBackground"></div></template>
    <!--?lit$823312683$-->Khôi phục tất cả
  </cr-button>
</cr-toast-manager>
<!--_html_template_end_--></template>
      </cr-most-visited>
...
<cr-toast id="undoToast" duration="10000"><template shadowrootmode="open"><!----><slot></slot></template>
  <div id="undoToastMessage"><!--?lit$823312683$--></div>
  <!--?lit$823312683$-->
</cr-toast>
<!--_html_template_end_--></template>
        </ntp-modules>
