const CACHE_NAME = 'lich-van-trung-pwa-v13'; // Nâng cấp lên v13 nhằm xóa sạch bộ đệm cũ và giải phóng file babel.min.js không sử dụng

// Danh sách các tài nguyên tĩnh nội bộ bắt buộc phải nạp đệm thành công để chạy Offline hoàn toàn (Không còn chứa babel.min.js)
